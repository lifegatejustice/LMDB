...
class App {
  constructor() {
    ...
    this.featuredMoviesContainer = document.getElementById("featured-movies-container");
    this.genresList = document.getElementById("genres-list");
    this.topRatedMoviesContainer = document.getElementById("top-rated-movies-container");
